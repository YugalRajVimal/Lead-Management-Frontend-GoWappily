...
//         {/* --- Start new filter bar in one line --- */}
...
//             {/* Tag chips */}
//             {allTags.length > 0 && (
//               <div className="flex flex-wrap items-center gap-1.5 md:ml-3 my-2 md:my-0">
//                 {allTags.map((t) => (
//                   <button
//                     key={t}
...
//             {/* Filters */}
//             <div className="flex flex-wrap md:flex-nowrap gap-2 items-center md:ml-3 my-2 md:my-0">
//               <Select
//                 value={status}
...
//           </div>
//           {/* Add Lead Button */}
//           <div className="flex md:ml-3 mt-2 md:mt-0 whitespace-nowrap">
...
//                       // ["sourceSheetName", "Source"],   // Removed Source column
//                       // ["tags", "Tags"],              // Removed Tags column
//                       ["status", "Status"],
//                       ["priority", "Priority"],
//                       ["assignedTo", "Assigned To"],
//                       ["createdAt", "Created"],
//                     ].map(([key, label]) => {
//                       const sortable = key !== "nextFollowUp";
//                       return (
//                         <th
//                           key={key}
//                           onClick={sortable ? () => toggleSort(key) : undefined}
//                           className={`px-4 py-2.5 font-medium whitespace-nowrap select-none ${
//                             sortable ? "cursor-pointer hover:text-slate-800" : ""
//                           }`}
//                         >
//                           {label}
//                           {sortable && sortBy === key && (sortOrder === "asc" ? " ↑" : " ↓")}
//                         </th>
//                       );
//                     })}
//                   </tr>
...
//                           )}
//                         </td>
//                         {/* Removed Source and Tags columns */}
