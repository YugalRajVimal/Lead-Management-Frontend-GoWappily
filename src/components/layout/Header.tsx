...
function linkFor(n: Notification) {
  ...
  // Tasks don't have a standalone route — they live inside their project's
  // Tasks tab, so task_assigned/task_due notifications deep-link to the
  // project instead (same as project_status_changed).
